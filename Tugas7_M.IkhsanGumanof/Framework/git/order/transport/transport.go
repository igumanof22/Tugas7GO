...
import (
	...
	ex "Tugas7_M.IkhsanGumanof/Framework/git/order/error"
...
func DecodeInquiryPaymentRequest(ctx context.Context, r *http.Request) (interface{}, error) {
	var body []byte
	...
	log.WithField("info", string(body[:])).Info("Decode Request Inquiry Payment API")
